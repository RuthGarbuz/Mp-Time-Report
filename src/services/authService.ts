...
type LoginResult = {
  success: boolean;
  message: string;
  // data is only present on success; keep optional to reflect runtime behavior
  data?: unknown;
};

class AuthService {
  // Index signature kept for compatibility with any dynamic property access elsewhere
  [x: string]: any;
