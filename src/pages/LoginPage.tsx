      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="p-6 pt-0 space-y-6">
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 ${ui.errors.email
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full pl-10 pr-12 py-3 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 ${ui.errors.password
                      ? 'border-red-300 focus:ring-red-200 bg-red-50'
                      : 'border-gray-300 focus:ring-purple-200 focus:border-purple-400 bg-gray-50 hover:bg-white'
                    }`}
            ...
            {/* Messages */}
            {ui.message && (
              <div className={`p-4 rounded-xl text-sm font-medium transition-all duration-300 ${ui.isSuccess
            ...
            <button
              ...
              className={`w-full py-4 px-4 rounded-xl font-bold text-white text-lg transition-all duration-200 ${ui.isLoading || security.isLocked
